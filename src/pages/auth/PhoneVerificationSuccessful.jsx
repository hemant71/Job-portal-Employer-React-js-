...
export default function PhoneVerificationSuccessful() {
    ...
    <div className="flex fixed top-0 left-0 bg-white w-screen h-screen">
      <div className="flex flex-col gap-14 items-center justify-center h-full w-1/2 px-14">
        ...
        <div className="flex  flex-col items-center gap-2">
                ...
                <p className="font-poppins text-[14px] font-[400] text-[#80807F]">Your phone has been successfully verified. You're all </p>
