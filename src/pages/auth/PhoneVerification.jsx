...
export default function PhoneVerification() {
          ...
          const interval = setInterval(() => {
            setCountdownTime((prevTime) => {
              if (prevTime <= 1) {
                ...
                setIsExpired(true);
                localStorage.removeItem('otpCountdown'); // Clear saved time when expired
                return 0;
              }
              const newTime = prevTime - 1;
              localStorage.setItem('otpCountdown', newTime); // Save the updated time in localStorage
              return newTime;
            });
          }, 1000);
        ...
        const resendOtp = () => {
          ...
          localStorage.setItem('otpCountdown', initialTime); // Save the reset time
        };
  return (
    <div className="flex fixed top-0 left-0 bg-white w-screen h-screen">
      <div className="flex flex-col pb-20 pt-10 items-center justify-between h-full w-1/2 px-14">
        <div className="flex  flex-col items-center gap-2">
                <p className="inline-flex gap-8  items-center font-poppins text-[32px] font-medium "><span><MdArrowBackIos/></span>Phone Verification</p>
                <p className="font-poppins text-[14px] font-[400] text-[#666666]">We've sent and verifcation to <b>+91 9876543233</b> to verify </p>
                <p className="font-poppins text-[15px] font-[400] text-[#666666]">your phone and activate your account.</p>
        </div>
